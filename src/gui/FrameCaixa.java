...
public class FrameCaixa extends JFrame {
	...
	public FrameCaixa() {
		...
		String[] pagamentos = { "Crédito", "Débito", "Espécie", "PIX", "Cheque" };
												...
												// SeleÃ§Ã£o de mesa para emissÃ£o de pagamento
		...
		btnComprovante.addActionListener(new ActionListener() {
			...
			bw.write("MÃ©todo de pagamento: " + metodo);
			bw.write(System.lineSeparator());
			String pagamento = valor.getText();
			if(metodo.equalsIgnoreCase("EspÃ©cie")) {
			...
			return;
				...
				JOptionPane.showMessageDialog(contentPane, "Mesa ainda nã foi encerrada");
